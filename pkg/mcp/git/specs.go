...
func ToolSpecs() []toolspec.ToolSpec {
	return []toolspec.ToolSpec{
		...
		{Server: "triagent-git", Name: "research_codebase", Description: "Run a sub-agent to answer a question about the repository's code at a ref (whole-tree, not a single change).", Inputs: toolspec.FromStruct(researchCodebaseIn{})},
